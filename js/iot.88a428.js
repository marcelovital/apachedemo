...
$(function(){
r=function(){dpi=window.devicePixelRatio;var e=document.querySelector('.js8');e.setAttribute('src',(dpi>1)?'images/ibm_logo-r-_redhat_lockup_horiz_rev_color_rgb-592.png':'images/ibm_logo-r-_redhat_lockup_horiz_rev_color_rgb-296.png');

var e=document.querySelector('.js10');e.setAttribute('src',(dpi>1)?'images/eingesetztes-bild-928.png':'images/eingesetztes-bild-464.png');
var e=document.querySelector('.js11');e.setAttribute('src',(dpi>1)?'images/eingesetztes-bild-562.png':'images/eingesetztes-bild-281.png');
var e=document.querySelector('.js12');e.setAttribute('src',(dpi>1)?'images/eingesetztes-bild-372.png':'images/eingesetztes-bild-186.png');};
